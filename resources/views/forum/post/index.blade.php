<x-layouts.app>
    ...
    <div class="row" style="margin-top: -2em;">
        ...
        <div class="bg-image d-flex justify-content-left align-items-center" style="
                        ...
                        height: 25vh;
                    ">
                        <h1 class="text-white" style="padding-left: 4em; padding-right: 1em;"><a style="color: whitesmoke; text-decoration: none" href="/community/{{$post->community->slug}}">{{$post->community->name}}</a></h1>
                ...
                <div class="col-md-9">
                    ...
                    <div class="card" >
                        ...
                        <div class="row" style="padding: 5px;">
                            ...
                            @include('forum.post.comment.comment', ['comments' => $post->comments, 'post_id' => $post->id])
