            ...
            <div style="margin:10px" id="filter-mobile">
             ...
             <div class="row g-0">
                 ...
                 <div class="card-body">
                     ...
                     <div class="d-block d-md-inline-block rounded" style="background: rgb(65, 52, 52); color:white; padding: 5px 15px 5px 15px; margin:3px"><i class="fa-solid fa-code" style="color: white"> </i>  {{count($alumni->profile->projects)}} Projects  </div>
