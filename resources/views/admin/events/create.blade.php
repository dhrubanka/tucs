    ...
    <div class="container-xl">
        ...
        {{-- <form method="POST" action="/event/store">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input id="start_date_time" type="datetime-local" class="form-control @error('start_date_time') is-invalid @enderror" name="start_date_time" value="{{ old('start_date_time') }}" required autocomplete="start_date_time">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input id="end_date_time" type="datetime-local" class="form-control @error('end_date_time') is-invalid @enderror" name="end_date_time" value="{{ old('end_date_time') }}" required autocomplete="end_date_time">
                    @error('end_date_time')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input id="organizer" type="text" class="form-control @error('organizer') is-invalid @enderror" name="organizer" value="{{ old('organizer') }}" required autocomplete="organizer">
                    @error('organizer')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
